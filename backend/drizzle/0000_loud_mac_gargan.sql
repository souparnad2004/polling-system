CREATE TYPE "public"."poll_status" AS ENUM('draft', 'published', 'closed');--> statement-breakpoint
...
CREATE TABLE "votes" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "votes_voter_token_unique" UNIQUE("voter_token"),
	CONSTRAINT "votes_poll_id_user_id_unique" UNIQUE("poll_id","user_id"),
	CONSTRAINT "votes_poll_id_voter_token_unique" UNIQUE("poll_id","voter_token")
);
--> statement-breakpoint
